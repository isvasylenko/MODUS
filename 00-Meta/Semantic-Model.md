...
Кожна сутність промаркована стандартом, з якого походить. Покриття: **TOGAF 28 · COBIT 23 · BIZBOK 19 · ITIL 11 · BRM 6** об'єктів.
...
### 5 об'єктів поза каноном — свідомі додатки
...
| **OKR** | Окрема практика (Doerr/Grove), не входить у жоден із п'яти | Квартальний ритм між стратегією і виконанням |
| **ML-модель** | Класичні метамоделі створені до AI-ери | **Головна прогалина канону** — і саме її закриває AI governance для QUANTUM |
| **Епік · Таска** | Delivery-рівень, нижчий за EA-граничність | Наскрізна простежуваність від цілі до конкретної роботи |
