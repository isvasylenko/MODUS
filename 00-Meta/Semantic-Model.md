...
Тип `persona` лишається в метамоделі як канонічний (TOGAF *Actor*) — без екземплярів. У реальному впровадженні він наповнюється всередині контуру компанії, у [[CAT-04-Role-Catalog]].
